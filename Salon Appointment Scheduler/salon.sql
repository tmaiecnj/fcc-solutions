...
--
-- Name: appointments fk_serviceid; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT fk_serviceid FOREIGN KEY (service_id) REFERENCES public.services(service_id);
